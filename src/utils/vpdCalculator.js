...
export function calculateVPD({ airTempC, relativeHumidity, leafTempC, defaultLeafOffset = -2.8, }) {
...
export function generateVPDTable({ temperatures = [20, 22, 24, 26, 28, 30], humidities = [40, 45, 50, 55, 60, 65, 70, 75, 80], leafOffset = 0, }) {
