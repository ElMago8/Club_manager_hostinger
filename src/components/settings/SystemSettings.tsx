            ...
            <>
              <div className="grid grid-cols-3 gap-4">
                ...
                <div className="rounded-lg border border-border p-3 text-center">
                  ...
                  <p className="text-xs text-muted-foreground">Fuentes internas</p>
                </div>
                <div className="rounded-lg border border-border p-3 text-center">
      ...
      <Card>
        ...
        <CardContent>
          <dl className="grid grid-cols-2 gap-2 text-sm">
            ...
            <dt className="text-muted-foreground">Platform</dt><dd className="font-medium">Cannabis Club Manager Inventory</dd>
          </dl>
        </CardContent>
      </Card>
