...
export const Route = createFileRoute("/app/help")({
  component: HelpPage,
  head: () => ({ meta: [{ title: "Help Center — Cannabis Club Manager" }] }),
});
    ...
    <div className="mx-auto max-w-[800px] space-y-6">
      <div className="flex items-center gap-3">
        ...
        <div>
          ...
          <p className="text-sm text-muted-foreground">Find answers to common questions about Cannabis Club Manager.</p>
        </div>
      </div>
